# -*- coding: utf-8 -*-
#
# PyQ documentation build configuration file, created by
...
project = u'Python for kdb+'
copyright = u'2013-2017, Enlightenment Research LLC'
author = u'Enlightenment Research LLC'
...
latex_documents = [
    (master_doc, 'PyQ.tex', u'PyQ Documentation',
     u'Enlightenment Research, LLC.', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyq', u'PyQ Documentation',
     [author], 1)
]
